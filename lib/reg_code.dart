...
import 'package:stud_chat/reg_password.dart';

class RegCodePage extends StatefulWidget {

  final String email;

  RegCodePage({required this.email});

  @override
  _RegCodePageState createState() => _RegCodePageState();
}

class _RegCodePageState extends State<RegCodePage> with SingleTickerProviderStateMixin {
                 ...
                 onChanged: (String value) async {
                   if (value.length == 6) {
                         Future.delayed(const Duration(milliseconds: 2000), () {
                           Navigator.push(
                               context,
                               CupertinoPageRoute(builder: (context) => RegPasswordPage()));
                         });
                   }
                 },
