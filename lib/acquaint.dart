...
import 'package:stud_chat/acquaint_new_form.dart';
...
class AcquaintTab extends StatefulWidget {
  ...
  AcquaintTab({this.onIndexChanged});
                  ...
                  child: Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                            context,
                            CupertinoPageRoute(builder: (context) => AcquaintNewFormPage()));
                      },
                      child: Image(
                        image: AssetImage('lib/assets/acquaint/new_form.png'),
                        fit: BoxFit.contain,
                        width: 26,
                        height: 26,
                      ),
