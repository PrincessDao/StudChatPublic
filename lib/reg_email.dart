...
import 'package:stud_chat/reg_code.dart';
...
class _RegEmailPageState extends State<RegEmailPage> with SingleTickerProviderStateMixin {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: 50,
              child: Text(
                'Пройдите регистрацию, предоставив ваш адрес электронной почты с действительным доменным именем',
                style: TextStyle(
                  fontSize: 12.0,
                  fontFamily: 'Inter',
            ...
            child: GestureDetector(
              onTap: isButtonDisabled
                ...
                Navigator.push(
                  context,
                  CupertinoPageRoute(
                    builder: (context) => RegCodePage(email: emailController.text),
                  ),
                );
              },
              child: Container(
