...
import 'package:stud_chat/reg_date.dart';
import 'package:stud_chat/reg_email.dart';

class RegPasswordPage extends StatefulWidget {
  @override
  _RegPasswordPageState createState() => _RegPasswordPageState();
}

class _RegPasswordPageState extends State<RegPasswordPage> with SingleTickerProviderStateMixin {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: 50,
              child: Text(
                'Создайте пароль, включая в него не менее семи символов. При этом обязательно добавьте хотя бы одну заглавную букву и одну цифру',
                style: TextStyle(
                  fontSize: 12.0,
                  fontFamily: 'Inter',
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: isButtonDisabled
                ...
                Navigator.push(
                    context,
                    CupertinoPageRoute(builder: (context) => RegDatePage()));
              },
                child: Container(
                  decoration: BoxDecoration(
